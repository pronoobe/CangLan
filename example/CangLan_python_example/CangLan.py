...
if __name__ == '__main__':
    ...
    formatter.add_new_command('cmd0', 0b0, (int, float,), ['i1', 'f1',])
    formatter.add_new_command('cmd1', 0b1, (int, float,), ['i2', 'f2',])
    formatter.add_new_command('cmd2', 0b10, (str,), ['s1',])
    formatter.add_new_command('cmd3', 0b11, (str,), ['s2',])
